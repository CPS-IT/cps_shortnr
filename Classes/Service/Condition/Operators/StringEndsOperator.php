...
class StringEndsOperator implements QueryOperatorInterface, DirectOperatorInterface
{
    /**
    ...
    public function supports(FieldConditionInterface $fieldCondition, OperatorContext $context, ?OperatorHistory $parent): bool
    {
        ...
        return $context->fieldExists($fieldCondition->getFieldName()) && is_array($fieldConfig) && array_key_exists(ConfigEnum::ConditionStringEnds->value, $fieldConfig);
    }
    ...
    public function process(FieldConditionInterface $fieldCondition, QueryOperatorContext $context, ?OperatorHistory $parent): ?string
    {
        ...
        $value = $condition[ConfigEnum::ConditionStringEnds->value] ?? null;
        if ($value === null) {
            return null;
        }
    ...
    public function directProcess(array $data, FieldConditionInterface $fieldCondition, DirectOperatorContext $context, ?OperatorHistory $parent): ?array
    {
        ...
        $conditionValue = $fieldCondition->getCondition()[ConfigEnum::ConditionStringEnds->value];
